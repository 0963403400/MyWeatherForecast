...
import LightRain from "../public/images/LightRain";
import NoRain from "../public/images/NoRain";
    ...
    <div className="weekly">
      ...
      {weeklyWeather.length > 0 &&
        weeklyWeather.map((weather, index) => {
          ...
          if(RainFallValue<0){
            RainFallValue=0;
            PathIm='/components/public/images/NoRain.png'
          }
          else
          {
            PathIm='/components/public/images/LightRain.png'
          }
