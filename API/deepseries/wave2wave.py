...
import torch
from .nn.cnn import WaveNet
from .nn.comm import Embeddings, Concat
from .nn.loss import RMSE


class Wave2Wave(nn.Module):
  #enc_cat_size là embed_size
    def __init__(self, target_size, enc_cat_size=None, enc_num_size=None, dec_cat_size=None, dec_num_size=None,
        ...
        print("Số kênh đầu vào mã hóa: ", enc_input_channels)
        print("Số kênh đầu vào giải mã: ", dec_input_channels)
